...
class _CircleColorPickerState extends State<CircleColorPicker>
  ...
  Future _sendOnMessageToBluetooth() async {
    print('===================RGB=========================');
    print('R${_color.red}G${_color.green}B${_color.blue}');
    print('===================RGB=========================');
    _connection.output.add(Uint8List.fromList(utf8.encode('R${_color.red}G${_color.green}B${_color.blue}' + '\n')));
    // _connection.output
    //     .add(ascii.encode('${_color.red}${_color.green}${_color.blue}'));
    // _connection.output.add(Uint8List.fromList(utf8.encode('R' + '\r\n')));
    // _connection.output.add(Uint8List.fromList(utf8.encode(_color.red.toString() + '\r\n')));
    // _connection.output.add(Uint8List.fromList(utf8.encode('G' + '\r\n')));
    // _connection.output.add(Uint8List.fromList(utf8.encode(_color.green.toString() + '\r\n')));
    // _connection.output.add(Uint8List.fromList(utf8.encode('B' + '\r\n')));
    // _connection.output.add(Uint8List.fromList(utf8.encode(_color.blue.toString() + '\r\n')));
  ...
  void initState() {
    ...
    print('\n\nConnection: ${_connection.isConnected}\n\n');
  }
